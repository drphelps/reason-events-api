...
var MnstrServer = require("@dphunkt/mnstr-server/src/MnstrServer.bs.js");
...
function main() {
  return MnstrServer.Http[/* make */3](/* Some */[(function ($$default) {
                ...
                })], /* None */0, /* None */0, /* Some */[Config.Server[/* port */0]], /* Some */[Config.Server[/* isDev */3]], /* Some */[onListen], /* () */0);
}
